...
import { getAllBooks, getAvailableBooks, getBooksWithDuplication, getBorrowedBooksForMember } from "../controllers/common.controller.js";
...
router.route('/getavailable').get(isCookieAuthorized, validateSchema(searchAllBookSchema), getAvailableBooks);
