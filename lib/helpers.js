 ...
 * @returns {Array|undefined} An array containing system constraints or undefined if an error occurs
 */
    ...
    try {
        ...
        if (!variables.length) {
            res.status(400).json({
                ...
                details: "Please update system variables: MAX_BORROW_LIMIT, EXPIRY_DATE, CONSECUTIVE_BORROW_LIMIT_DAYS, MAX_RENEWAL_LIMIT"
            });
        }
